...
var FileStorageRoute = require('./routes/fileStorageRoute');
...
function registerRoutes() {
    ...
    app.use('/api', new FileStorageRoute('./json/owncloudRoutes.json').route(router));
    app.use('/api', new FileStorageRoute('./json/dropboxRoutes.json').route(router));
    app.use('/api', new FileStorageRoute('./json/googleDriveRoutes.json').route(router));
